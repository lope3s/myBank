...
exports.transactionRoute.post('/createTransaction', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, type, value, userId, goalId_1, user, treatedValue, transactionGoal, goals, transactionObject, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                treatedValue = type === 'Withdraw' ? -1 * parseFloat(value) : parseFloat(value);
...
exports.transactionRoute.get('/transactionList/:userId/:goalId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, goalId, user, transactionHistory;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2:
                transactionHistory = _b.sent();
                return [2 /*return*/, res.status(200).send({ transactionHistory: transactionHistory }).end()];
        }
    });
}); });
