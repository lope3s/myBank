...
var db_1 = require("../../db");
var checkUserService_1 = __importDefault(require("../checkUserService"));
var passwordHash_1 = __importDefault(require("../passwordHash"));
var db = db_1.client.db();
exports.route = express_1.default.Router();
exports.route.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
