...
var keepServerAliver_1 = __importDefault(require("./services/keepServerAliver"));
...
app.get('/', function (req, res) {
    ...
    (0, keepServerAliver_1.default)('https://mybankbacksideserver.herokuapp.com/');
    return res.status(200).end();
});
app.listen(process.env.PORT || 5001, function () { return __awaiter(void 0, void 0, void 0, function () {
    var transporter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                transporter = _a.sent();
                transporter === null || transporter === void 0 ? void 0 : transporter.verify(function (err, _succes) {
                    if (err) {
                        console.log(err);
                    }
                    else {
